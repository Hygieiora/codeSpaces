    ...
    <>
      ...
      <div className="container mx-auto px-4">
        <Head>
          ...
          <meta
            name="description"
            content="Terms and Conditions for Hygieiora"
          />
        </Head>
        ...
        <main className="my-10">
          ...
          <section className="flex flex-col items-center justify-center space-y-4">
            ...
            <p>
              Outline the responsibilities and obligations of the user while
              using the application.
            </p>

            <h2 className="text-2xl font-semibold">Intellectual Property</h2>
            <p>
              State that your application and all its original content,
              features, and functionality are owned by Hygieiora and are
              protected by international copyright and other intellectual
              property laws.
            </p>
