export default function SideBar() {
  return (
    <div className="hidden md:block h-full fixed md-hidden sm-hidden bg-white p-3 space-y-2 w-60 dark:bg-gray-900 dark:text-gray-100">
      ...
      <div className="divide-y justify-between dark:divide-gray-700">
