  ...
  return (
    ...
    <div className="overflow-hidden">
        <section className="flex-1 min-h-screen w-[600px]">
            ...
            <div className="mb-6">
                <h2 className="text-blue-600 font-bold text-[60px] mt-20 leading-normal">Welcome back!</h2>
                <h1 className="text-black font-inter font-bold leading-normal text-6xl mb-3">Log In</h1>
            </div>
            ...
            <form action="" className="flex flex-col">
                ...
                <div className="mt-6 mx-auto gap-4">
                    ...
                    <button className="w-[230px] h-[60px] bg-blue-600 rounded-full text-white  text-lg font-normal">Sign in</button>
                    </Link>
                </div>
            </form>
